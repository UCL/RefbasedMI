...
We present and describe an R package, \texttt{mimix}, for performing reference-based imputation, including a causal model variant, and we compare its implementation with that in SAS and Stata.
}
